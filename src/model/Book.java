...
public class Book extends Consumable {
    ...
    public Book(String name, Float rating, Date startingDate, Date endingDate, double consumptionTimeInHours) throws ParseException, ConsumableEndedException, NegativeValueException {
